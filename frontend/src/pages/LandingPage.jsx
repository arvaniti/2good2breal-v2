...
const coupleImages = [
  ...
  {
    url: "https://static.prod-images.emergentagent.com/jobs/3b0bb19a-dfb7-4f27-b093-a7f016f93d48/images/3cbc440583bcd5bae88ba03c3788261f208cbfe19264bce0f376836182a814d1.png",
...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-4xl sm:text-5xl font-bold text-yellow-400 mb-2">120K+</div>
      ...
      <section id="features" className="py-24 sm:py-32 pb-6 sm:pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6 text-lg text-zinc-300 leading-relaxed">
            ...
            <div className="mt-4 bg-zinc-800/50 border border-zinc-700 rounded-xl p-4">
              ...
              <p className="text-zinc-300 -ml-2">
                WhatsApp : <a href="tel:+33743660555" className="text-purple-400 hover:text-purple-300 underline">+33 (0) 7 43 66 05 55</a>
              </p>
              <p className="text-zinc-300 -ml-2">
                Email : <a href="mailto:contact@2good2breal.com" className="text-purple-400 hover:text-purple-300 underline">contact@2good2breal.com</a>
              </p>
      ...
      <button
        onClick={() => {
          const url = "https://wa.me/33743660555?text=Hello%2C%20I%20would%20like%20to%20make%20a%20personal%20enquiry%20and%20receive%20information%20about%20profile%20submission.";
